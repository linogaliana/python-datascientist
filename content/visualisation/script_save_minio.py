...
year = 2021
url_naissance = (
    f"https://www.insee.fr/fr/statistiques/fichier/2540004/nat{year}_csv.zip"
)
...
df = pd.concat(
    [jean_deces.assign(source="deces"), jean_naiss.assign(source="naissance")]
)
