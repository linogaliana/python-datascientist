...
compteurs = gpd.read_file("https://parisdata.opendatasoft.com/api/explore/v2.1/catalog/datasets/comptage-velo-donnees-compteurs/exports/geojson?lang=fr&timezone=Europe%2FParis")
#compteurs.head()
```
