...
![`ggplot` (and `plotnine`) logic, picture borrowed to [Andrew Heiss {{< fa arrow-up-right-from-square >}}](https://datavizf24.classes.andrewheiss.com/lesson/04-lesson.html#changing-colors-shapes-and-sizes-with-scale_){target="_blank"}](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/datavizf24-ggplot-layers-4x.png){width=60%}
