...
![Comprendre l'architecture d'une figure `matplotlib` (Source: [documentation officielle](https://matplotlib.org/stable/users/explain/quick_start.html))](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/matplotlib-anatomy.png){#fig-matplotlib width=50%}
...
![Understanding the Anatomy of a `matplotlib` Figure (Source: [Official Documentation](https://matplotlib.org/stable/users/explain/quick_start.html))](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/matplotlib-anatomy.png){#fig-matplotlib}
