...
![Exemple de _range plot_ par Eric Mauvière ([ssphub.netlify.app/ {{< fa arrow-up-right-from-square >}}](https://ssphub.netlify.app/talk/2024-02-29-mauviere/){target="_blank"}).](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/ssphub-mauviere.png)
...
![Example of a range plot by Eric Mauvière ([ssphub.netlify.app/ {{< fa arrow-up-right-from-square >}}](https://ssphub.netlify.app/talk/2024-02-29-mauviere/){target="_blank"}).] (https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/ssphub-mauviere.png)
:::
