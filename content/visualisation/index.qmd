...
un choix rationnel. Il est d'ailleurs possible de séparer le _front_ et le _back_
en reportant les calculs vers une API, construite par exemple par le biais de [`FastAPI`](https://fastapi.tiangolo.com/). Encore une fois, il s'agit d'éléments qui dépassent
un niveau introductif en `Python` mais avoir conscience des bons réflexes
peut faire économiser un temps non négligeable en évitant de patauger
