...
de [`Great Tables`](https://posit-dev.github.io/great-tables/articles/intro.html) constituait déjà un progrès dans cette démarche mais, en vérité,
...
[`Great Tables`](https://posit-dev.github.io/great-tables/articles/intro.html) was already a step forward in this process but, in truth,
...
::: {.content-visible when-profile="fr"}
## La visualisation des données, une part essentielle du travail de communication
...
![Un exemple de deux visualisations faites sur le même jeu de données par Eric Mauvière, voir @nte-mauviere](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/ssphub-mauviere.png)
:::
...
![An example of two visualizations made from the same dataset by Eric Mauvière, see @nte-mauviere](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/ssphub-mauviere.png)
:::
...
::: {.content-visible when-profile="fr"}
Comme le rappellent les travaux de recherche en sciences cognitives,
la perception des graphiques est une opération cognitive complexe qui 
consiste à appréhender des relations quantitatives (hiérarchie, intensité...) à partir de signaux
visuels. Des facteurs innés - par exemple une meilleure capacité à transposer des positions que des couleurs en information quantitative - et des facteurs culturels - la familiarité à différentes formes de dataviz - vont avoir un effet sur la compréhension d'une figure. Le cours au collège de France de Stanislas Dehaene sur la [perception des graphiques](https://www.college-de-france.fr/fr/agenda/cours/la-perception-des-graphiques-un-nouvel-exemple-de-recyclage-neuronal) évoque ces enjeux et revient sur l'histoire de la visualisation de données. A ce sujet, la bibliothèque de l'Insee a organisé une exposition en 2025 avec quelques visualisations qui valent le détour et apparaissent d'une étonnante modernité.
:::

::: {.content-visible when-profile="en"}
As cognitive science research reminds us, the perception of charts is a complex cognitive operation that involves grasping quantitative relationships (hierarchy, intensity, etc.) from visual signals. 

Innate factors — for example, a better ability to interpret positions rather than colors as quantitative information — and cultural factors — such as familiarity with different forms of data visualization — influence how well a figure is understood. 

Stanislas Dehaene’s [Collège de France lecture on chart perception](https://www.college-de-france.fr/fr/agenda/cours/la-perception-des-graphiques-un-nouvel-exemple-de-recyclage-neuronal) discusses these issues and traces the history of data visualization. 

On this topic, the Insee library organized an exhibition in 2025 showcasing several visualizations that are worth seeing and appear surprisingly modern.
:::
...
<details open>
  <summary style="cursor:pointer; font-weight:600;">
    History of dataviz (INSEE) - click to collapse/expand
  </summary>

  <div style="margin-top:0.5rem;">
    <embed
      src="https://minio.lab.sspcloud.fr/lgaliana/python-ENSAE/inputs/dataviz/insee_dataviz_compressed.pdf"
      type="application/pdf"
      width="100%"
      height="1000"
    />
    <p>
      <a href="https://minio.lab.sspcloud.fr/lgaliana/python-ENSAE/inputs/dataviz/insee_dataviz_compressed.pdf" download>
        Download the PDF
      </a>
      •
      <a href="https://minio.lab.sspcloud.fr/lgaliana/python-ENSAE/inputs/dataviz/insee_dataviz_compressed.pdf" target="_blank" rel="noopener">
        Open in new tab
      </a>
    </p>
  </div>
...
easily produce data visualizations[^1-en].
...
other frameworks exist in this field[^2-en].

[^1-en]: To be honest, for a long time, `Python` was a bit less enjoyable in this regard 
...
[^2-en]: In this regard, I highly recommend keeping up with data visualization 
...
:::: {.callout-tip}
## Some resources on `Streamlit` or `Dash`

Besides the [3rd-year course](https://ensae-reproductibilite.github.io/website/) (in French) at ENSAE,
Insee's data science lab has built many tutorials
to get to grips with the ecosystems of reactive applications in `Python`, which
are among the most attractive products of the `Python` ecosystem. 

Here, for example, is a very detailed [101 tutorial](https://inseefrlab.github.io/funathon2023_sujet4/) on `Streamlit` for building a [`Yuka`-style application](https://myyuka.lab.sspcloud.fr/) on `openfoodfacts` data. Another step-by-step tutorial built by Insee
is devoted to `streamlit` and aims at building an [air traffic dashboard](https://inseefrlab.github.io/funathon2024_sujet2/). 
