...
This chapter focuses on data visualization and tackles a common task faced by data scientists and data engineers: creating effective figures for dashboards. To explore this, we’ll recreate several examples found online - some better than others - and use a variety of `Python` visualization libraries to evaluate their respective strengths and limitations.
