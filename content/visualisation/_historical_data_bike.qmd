...
def download_unzip_and_read(url, extract_to='.'):
    ...
    try:
        ...
        with zipfile.ZipFile(io.BytesIO(response.content)) as z:
            ...
            csv_filename = [f for f in extracted_files if file_pattern in f and f.endswith('.csv')]
...
def read_historical_bike_data(year):
    ...
    df_comptage = download_unzip_and_read(url_comptage, extract_to='./extracted_files')
