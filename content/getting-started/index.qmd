...
image: https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/ensaereproductibilite-egg.jpg
...
:::: {.content-visible when-profile="fr"}
De manière plus détaillée, voici le plan du cours:
::::

:::: {.content-visible when-profile="en"}
In more detail, here is the course outline:
::::
...
%run "./build/homepage/syllabus.py"

syllabus = build_syllabus_pipeline(
    "./doc/syllabus.json", lang = os.getenv("QUARTO_PROFILE") or "fr"
)
```
