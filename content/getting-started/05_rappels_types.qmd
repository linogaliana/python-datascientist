...
<!-- KA : sur la phrase précédente : est-ce bien vrai ? Sur jupyter notebook oui en tous cas. Cela doit dépendre non pas du langage mais de l'IDE, non ? Tu en parles ci-dessous d'ailleurs. Je supprimerais la phrase précédente ou la préciserais. -->
...
<!-- KA : Ce n'est pas vraiment un exercice -->
