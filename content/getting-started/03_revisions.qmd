...
filters: 
  - live
image: https://minio.lab.sspcloud.fr/lgaliana/generative-art/pythonds/bored_kid.png
---
...
::: {.content-visible when-profile="fr"}
Le contenu de cette page est disponible sur [le site web du cours](https://pythonds.linogaliana.fr/content/getting-started/03_revisions.html)
:::

::: {.content-visible when-profile="en"}
The content of this page is available on [the course website](https://pythonds.linogaliana.fr/en/content/getting-started/03_revisions.html)
:::
::::
