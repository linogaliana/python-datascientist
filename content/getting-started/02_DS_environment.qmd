...
## `matplotlib` et `seaborn` {.unnumbered}
...
## `TensorFlow`, `PyTorch` et `Keras` {.unnumbered}
...
##  `requests` et `beautifulsoup` {.unnumbered}
...
* [Sphynx](https://www.sphinx-doc.org/en/main/) et [JupyterBook](https://jupyterbook.org/intro.html) proposent des modèles de documentation
très complets
