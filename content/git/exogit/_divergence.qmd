...
![Historique de Bob en retard (cas simple)](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/githubusercontent-ff.png){#fig-history-simple}
...
![Historique de Bob en retard (cas plus compliqué)](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/githubusercontent-divergence.png){#fig-history-complicated}
...
![Historique de Bob en retard: résolution par _merge_](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/githubusercontent-merge_commit_local.png){#fig-history-merge}
...
![](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/githubusercontent-rebase1.png){#fig-history-rebase1}
...
![](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/githubusercontent-rebase2.png){#fig-history-rebase2}
...
![Bob's history when behind (simple case)](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/githubusercontent-ff.png){#fig-history-simple}
...
![Bob's history when behind (more complicated case)](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/githubusercontent-divergence.png){#fig-history-complicated}
...
![Bob's history when behind: resolution by _merge_](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/githubusercontent-merge_commit_local.png){#fig-history-merge}
