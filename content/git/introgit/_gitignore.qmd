...
containerQuestionGit2 = {
  ...
  let container = html`<div class="question-container"><div class="question-text">${textQuestion2}</div><div class="question-input">${viewof questionGit2}</div><br><div class="question-message">${messageQuestion2Response}</div></div>`;
