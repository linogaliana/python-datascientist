...
::: {.callout-tip}
## Exercice 3bis: stocker son jeton (pour les utilisateurs du `SSPCloud`)
...
::: {.callout-tip}
## Exercice 3ter: stocker son jeton (pour les personnes n'ayant pas l'accès au `SSPCloud`)
...
::: {.callout-tip}
## Exercise 3bis: store your token (for `SSPCloud` users)
...
::: {.callout-tip}
## Exercise 3ter: store your token (for people without `SSPCloud` access)
