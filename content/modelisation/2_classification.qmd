...
![Example of a decision tree on the classic iris dataset. Source: [scikit-learn documentation](https://scikit-learn.org/stable/modules/tree.html)](https://scikit-learn.org/stable/_images/iris.svg){#fig-iris-classification-en fig-width="80%"}
