...
2. Créer `temp`, un DataFrame dont tous les variables ont été standardisées. Refaire la matrice de corrélation pour déterminer s'il y a un changement dans les *features* pouvant expliquer `rep16_frac`
{{% /panel %}}
