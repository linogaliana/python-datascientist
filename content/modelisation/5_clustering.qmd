...
![](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/wikimedia-Scikit-learn_machine_learning_decision_tree.png)
...
![](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/scikit-learn-sphx_glr_plot_kmeans_assumptions_001.png)
...
:::: {.content-visible when-profile="en"}
The inertia of our model is as follows:
::::
...
:::: {.content-visible when-profile="en"}
Where the distortion follows the curve
::::
