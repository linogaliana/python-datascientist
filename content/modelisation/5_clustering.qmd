---
title: "Introduction à l'apprentissage non supervisée avec le clustering"
title-en: "Clustering"
categories:
  - Modélisation
  - Exercice
...
5. Choisir les variables `Median_Household_Income_2019` et `Unemployment_rate_2019` et représenter le nuage de points en colorant différemment en fonction du label obtenu. Quel est le problème ?
...
5. Choose the variables `Median_Household_Income_2019` and `Unemployment_rate_2019` and represent the scatter plot, coloring it differently based on the obtained label. What is the problem?
...
the relationship between `Median_Household_Income_2019`
...
This suggests that the income variable (`Median_Household_Income_2019`)
