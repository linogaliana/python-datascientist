...
- Installer les packages `fastAPI` et `uvicorn`
...
Récupérer le contenu sur [cette page](https://raw.githubusercontent.com/linogaliana/pythondatascientist/appli17/train.py)
</details>
