...
d'intégrer l'effet
confinement strict dans vos modèles. 
Pour cela, vous pouvez créer une variable
...
### Définition des ensembles _train_/_test_
...
```{python}
mutations2 = mutations.drop(colonnes_surface.tolist() + ["Date mutation", "lprix", "confinement"], axis = "columns").copy()
...
X_train, X_test, y_train, y_test = train_test_split(
    ...
    test_size = 0.2, random_state = 0, stratify=mutations2[['dep']]
)
```
