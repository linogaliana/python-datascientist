...
sources est directement fourni. Vous pouvez essayer de le faire en exercice sans 
...
os.mkdir("data/")
download_url("https://www2.census.gov/geo/tiger/GENZ2019/shp/cb_2019_02_sldl_500k.zip", "data/shapefile")
with zipfile.ZipFile("data/shapefile", 'r') as zip_ref:
    zip_ref.extractall("data/counties")

shapefile_source = "https://www2.census.gov/geo/tiger/GENZ2019/shp/cb_2019_02_sldl_500k.zip"

shp = gpd.read_file("counties/cb_2019_us_county_500k.shp")
...
shp2 = shp.merge(df_election, left_on = "FIPS", right_on = "county_fips")
```
...
fig = px.scatter_geo(votes, size="CENSUS_2010_POP",
                     color="winner")
fig.show()
```

```{python}
markersize = votes['CENSUS_2010_POP']/100000

fig, ax = plt.subplots(figsize=(12,12))
votes.plot(ax=ax, color="lightgray", edgecolor="grey", linewidth=0.4)
grouped = votes.groupby('winner')
for key, group in grouped:
    group.plot(ax=ax, markersize=markersize, alpha=0.7, categorical=False, label=key, color=color_dict[key])
#votes.plot(ax=ax,color="winner", markersize="CENSUS_2010_POP",alpha=0.7, categorical=False, legend=True )
ax.axis("off")
plt.axis("equal")
plt.show()
```
...
votes[["winner", 'Unemployment_rate_2019', 'Median_Household_Income_2019', 'Percent of adults with less than a high school diploma, 2015-19', "Percent of adults with a bachelor's degree or higher, 2015-19"]]
...
```{python}
df2 = votes.set_index("GEOID")[["votes_gop", 'Unemployment_rate_2019', 'Median_Household_Income_2019', 'Percent of adults with less than a high school diploma, 2015-19', "Percent of adults with a bachelor's degree or higher, 2015-19"]]
