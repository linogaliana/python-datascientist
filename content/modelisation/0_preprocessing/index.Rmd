...
```{r, include=FALSE}
path_plot <- here::here("static","plotly_temp")
```
...
htmlsnip2 = plotly.io.to_html(fig, include_plotlyjs=False)
fig.write_json(r.path_plot + "/plot_name.json")
```

{{< plotly json="/plotly_temp/plot_name.json" height="400px" >}}
...
```{python}
fig = df2.drop("winner", axis = 1).corr().style.background_gradient(cmap='coolwarm').set_precision(2)
fig
plt.show()
```
