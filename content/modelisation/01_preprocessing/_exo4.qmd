...
::: {.content-visible when-profile="en"}
```{python}
#| fig-cap: "Question 2, before normalization"
p1
```
...
::: {.content-visible when-profile="en"}
```{python}
#| fig-cap: "Question 2, transformed variable, on the normalization sample"
p2
```
...
::: {.content-visible when-profile="en"}
```{python}
#| fig-cap: "Question 2, transformed variable, using the trained parameters"
p3
```
