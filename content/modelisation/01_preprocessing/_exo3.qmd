...
::: {.content-visible when-profile="en"}
```{python}
#| fig-cap: "Standardized unemployment rate on observations used for training"
#| label: "fig-exo3-q3-en"
#| message: false
#| output: false
X1 = pd.DataFrame(scaler.fit_transform(df_exo3[1000:]))
X1.columns = df_exo3.columns
...
::: {.content-visible when-profile="en"}
```{python}
#| fig-cap: "Standardized unemployment rate on observations not used for training"
#| label: "fig-exo3-q3bis-en"
#| message: false
#| output: false
(
  ggplot(X2, aes(x = "Unemployment_rate_2019")) +
