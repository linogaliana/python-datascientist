...
1. Using a few variables, for example, *'Unemployment_rate_2019', 'Median_Household_Income_2019', 'Percent of adults with less than a high school diploma, 2015-19', "Percent of adults with a bachelor's degree or higher, 2015-19"*, explain the variable `per_gop`.  
⚠️ Use the variable `Median_Household_Income_2019` in `log` form; otherwise, its scale might dominate and obscure other effects.
...
4. Use the `formula` API to regress the Republican score as a function of the variable `Unemployment_rate_2019`, `Unemployment_rate_2019` squared, and the log of `Median_Household_Income_2019`.
:::
