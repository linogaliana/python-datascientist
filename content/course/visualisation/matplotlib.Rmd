...
2. Refaire le graphique *Les 10 compteurs ayant comptabilisés le plus de vélos*
...
fig2 = px.bar(df1.sort_values('Comptage horaire', ascending=True), orientation='h', x='Comptage horaire',
              y='Nom du compteur',  color='top', ## attention, l'argument color ne semble pas fonctionner. TODO
