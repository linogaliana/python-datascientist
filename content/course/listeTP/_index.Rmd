...
```{r, echo = FALSE, results = 'asis', include = TRUE, eval = TRUE}
print_badges("content/course/manipulation/04a_webscraping_TP.Rmd")
```

* [Utiliser des API avec `Python`](#api)
```{r, echo = FALSE, results = 'asis', include = TRUE, eval = TRUE}
print_badges("content/course/manipulation/04c_API_TP.Rmd")
```
...
```{r, echo = FALSE, results = 'asis', include = TRUE, eval = TRUE}
print_badges("content/course/visualisation/matplotlib.Rmd")
```

* [Faire de belles cartes avec `Python`](#cartoTP)
```{r, echo = FALSE, results = 'asis', include = TRUE, eval = TRUE}
print_badges("content/course/visualisation/maps.Rmd")
```
