...
print_badges("content/course/getting-started/04_rappels_types.Rmd")
```

* [Des rappels sur les fonctions en python](#rappelsfonctions)
```{r, echo = FALSE, results = 'asis', include = TRUE, eval = TRUE}
print_badges("content/course/getting-started/05_rappels_fonctions.Rmd")
```


* [Un TD (optionnel) sur les classes en python](#rappelsclasses)
```{r, echo = FALSE, results = 'asis', include = TRUE, eval = TRUE}
print_badges("content/course/getting-started/06_rappels_classes.Rmd")
```
