...
::: {layout-ncol=2}
![Wordcloud start OpenFood](wordcloud_openfood_start.png)

![Wordcloud start RelevanC](wordcloud_relevanc_start.png)
:::

::: {layout-ncol=2}
![Wordcloud start OpenFood](wordcloud_openfood_clean.png)

![Wordcloud start RelevanC](wordcloud_relevanc_clean.png)
:::
