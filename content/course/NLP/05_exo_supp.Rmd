...
plt.imshow(wordcount_words(df_openfood, yvar = "product_name"))
plt.axis('off')
plt.savefig('{}.png'.format("product_name"), bbox_inches='tight')


plt.imshow(wordcount_words(df_openfood, "tokenized"))
plt.axis("off")
plt.savefig('{}.png'.format("tokenized"), bbox_inches='tight')
```
