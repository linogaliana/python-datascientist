...
Le but va être dans un premier temps de regarder dans le détail les termes les plus fréquemment utilisés par les auteurs, de les représenter graphiquement puis on va ensuite essayer de prédire quel texte correspond à quel auteur à partir d'un modèle `Word2Vec`.
...
{{% panel status="warning" title="Attention" icon="fa fa-exclamation-triangle" %}}
...
url = 'https://raw.githubusercontent.com/antuki/python-datascientist/relec-ka-1112/content/course/NLP/get_data.py'
