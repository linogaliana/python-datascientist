...
```{r, eval = TRUE, echo = FALSE, fig.cap = "The burden of correction, borrowed to PHD Comics https://twitter.com/PHDcomics/status/1306536945980383232?s=20"}
knitr::include_graphics("https://twitter.com/PHDcomics/status/1306536945980383232/photo/1")
```
...
```{r, echo = FALSE}
knitr::include_graphics("https://gitlab.com/linogaliana/collaboratif/-/raw/master/pics/03_git/push_pull_Drees.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("https://gitlab.com/linogaliana/collaboratif/-/raw/master/pics/03_git/trois_%C3%A9tats_fichier.png")
```
