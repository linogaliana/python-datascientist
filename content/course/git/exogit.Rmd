...
Dans ce chapitre, nous allons proposer d'utiliser `Github` comme forge
logicielle. Les principes vus ici sont directement transposables
à `Gitlab` qu'on rencontre également fréquemment[^1].
...
## Authentification et token HTTPS
