...
Ce code introduit une base nommée `votes` dans l'environnement. Elle a l'aspect
suivant:
...
```{python, warning = FALSE, echo=TRUE, message = FALSE}
import numpy as np
...
```{r, echo = FALSE}
knitr::include_graphics("scikit_predict.png")
```
