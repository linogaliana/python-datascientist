...
print("Sur cet échantillon, le taux de réussite moyen était, en 2018, de {:.2%}".format(moyenne_nationale))
```
...
```{python}
dfgeoloc = x.loc[:, ['Adresse','CP','Ville']].apply(lambda s: s.str.lower().str.replace(","," "))
...
df_pal = dfgeo.loc[dfgeo['Ville'].isin(["massy", "palaiseau"])]
