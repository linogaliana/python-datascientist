...
* Quelques ingrédients d'une recette de cuisine (au choix sur marmiton.org)

```{python}
url = 'https://www.marmiton.org/recettes/recette_veloute-de-potiron-et-carottes_19009.aspx'
...
* Un ticket de caisse  
L'information contenue dans les libellés des tickets de caisse contient beaucoup d'abbréviations, et n'est pas toujours facilement interprétable
...
```{python}
libelles = ticket + scraper.ingredients()
```
