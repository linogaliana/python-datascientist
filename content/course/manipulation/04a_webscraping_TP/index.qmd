...
Les prochaines parties permettront de faire cet exercice étape par étape, 
de manière guidée.
...
Pour cet exercice, on propose de scraper la liste des ministres français depuis le [site du gouvernement](https://www.gouvernement.fr/composition-du-gouvernement). L'objectif sera, _in fine_ de faire une graphique qui représente la distribution de leurs âges.
...
3. Utiliser `find_all` pour récupérer la liste des ministres dans `compo` 
2. Inspecter la page du site du gouvernement et répérer les id `biography`. Remarquer
la structure. 
...
Les âges égaux à 0 sont une 'erreur' de scraping : lorsque la date de naissance complète n'est pas disponible sur la biographie d'un ministre.
