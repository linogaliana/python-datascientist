...
Scraper la liste des ministres français depuis le [site du gouvernement](https://www.gouvernement.fr/composition-du-gouvernement). Faire une graphique qui représente la distribution de leurs âges.
...
## Obtenir la liste des  ministres et leurs âges

```{python}
html = urllib.request.urlopen(url_gouvernement + suffixe_ministres).read()
page = bs4.BeautifulSoup(html)
