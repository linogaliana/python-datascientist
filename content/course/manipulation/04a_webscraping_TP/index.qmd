...
<h3 class="alert-heading"><i class="fa-solid fa-pencil"></i> Exercice 1 : Récupérer les participants</h3>
```
...
On va d'abord afficher la première ligne:
...
Celle-ci correspond aux entêtes de colonnes:
...
Ce qui correspond au code brut de cette ligne, une 
fois mise en forme:
