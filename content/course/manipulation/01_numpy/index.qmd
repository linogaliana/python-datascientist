...
<!-- Les titres des exercices disparaissent du notebook -->

{{% box status="exercise" title="Exercice 3" icon="fas fa-pencil-alt" %}}
...
{{% box status="exercise" title="Exercice 4" icon="fas fa-pencil-alt" %}}
...
{{% box status="exercise" title="Exercice 5" icon="fas fa-pencil-alt" %}}
...
{{% box status="exercise" title="Exercice (un peu corsé)" icon="fas fa-pencil-alt" %}}
