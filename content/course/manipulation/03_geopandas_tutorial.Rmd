...
`r emo::ji("one")` Afficher le nuage de point de 200 stations vélibs prises au hasard
...
`r emo::ji("two")`  Y ajouter en dessous les contours des communes
...
`r emo::ji("three")`  Y ajouter un fond de carte de type *open street map* grâce au package
`contextily`
...
`r emo::ji("four")`  Retirer les axes des coordonnées
