...
```{r, echo = FALSE, results = 'asis', include = TRUE, eval = FALSE}
print_badges()
```
...
for i in range(0,len(gdf)):
    folium.Marker([gdf.iloc[i]['lat'], gdf.iloc[i]['lon']], popup=gdf.iloc[i]['stade']).add_to(m)
...
{{% panel status="exercise" title="Exercice 2 [BONUS] Les ministres sur wikipédia" icon="fas fa-pencil-alt" %}}
