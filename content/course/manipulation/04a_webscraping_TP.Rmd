...
- Sous `Chrome` `r fontawesome::fa("fab fa-chrome")` : Cliquez ensuite sur "Affichez le code source de la page" (<kbd>CTRL</kbd>+<kbd>U</kbd>) ;
- Sous `Firefox` `r fontawesome::fa("fab fa-firefox")` : "Code source de la page" (<kbd>CTRL</kbd>+<kbd>MAJ</kbd>+<kbd>K</kbd>) ;
- Sous `Edge` `r fontawesome::fa("fab fa-edge")` : "Affichez la page source" (<kbd>CTRL</kbd>+<kbd>U</kbd>) ;
- Sous `Safari` `r fontawesome::fa("fab fa-safari")` : voir comment faire [ici](https://fr.wikihow.com/voir-le-code-source)
...
`r emo::ji("comment")` *Mais pourquoi apprendre ça pour "scraper", me direz-vous ?*
