...
3. Trouver les toilettes publiques les plus proches des stations de vélib autour d'Edgard Quinet.
...
{{% box status="exercise" title="Télécharger et dézipper vous-même le fonds de carte" icon="fas fa-pencil-alt" %}}
