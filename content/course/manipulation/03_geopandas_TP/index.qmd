...
1. Utiliser la fonction `download_unzip` avec l'url <https://www.data.gouv.fr/fr/datasets/r/0e117c06-248f-45e5-8945-0e79d9136165>
...
Cette [page](https://geopandas.org/mapping.html#maps-with-layers) peut vous aider pour comprendre comment afficher plusieurs couches à la fois.
...
<!-- EXERCICE REVU EN RAISON D'UN LIEN MORT : ON CHANGE DE THEME : plus de stations de métro mais des toilettes publiques ! -->
