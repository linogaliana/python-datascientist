...
```{python}
#| echo: false
data_books.loc[~data_books['Date of Publication'].isna() & data_books['Date of Publication 2'].isna(), ['Date of Publication', 'Date of Publication 2']]
```
...
```{python}
#| echo: false
pd.to_numeric(data_books['Date of Publication 2'], downcast='integer').plot(kind ="hist")
```
