...
Nous suivrons les conventions habituelles dans l'import des packages, notamment
les raccourcis de noms
pour les packages `pandas`, `numpy` et `matplotlib.pyplot`
