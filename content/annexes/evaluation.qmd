...
Tout usage abusif des IA génératives, c'est-à-dire sans effort apparent de reprise de celui-ci, sera sanctionné. Pour être transparent avec vos évaluateurs, si vous avez utilisé des IA génératives, indiquer lesquelles et les prompt que vous avez utilisé dans un fichier `doc/genAI.md`. La présence de ce fichier est là pour permettre à vos évaluateurs de vous faire un retour sur votre usage de cet outil mais, à nouveau, si vous n'avez pas fait d'effort, vous serez sanctionné.
:::
