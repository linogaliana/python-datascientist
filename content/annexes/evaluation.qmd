...
* A la fin du semestre, les étudiants rendront un projet informatique par __groupe de 3 personnes.__
* Ce projet dont le __sujet est libre__ devra comporter:
    ...
    - Une exploration de l'information présente dans ces jeux de données par le biais, notamment, de statistiques descriptives ; 
    - De la visualisation ;
...
Les principales _deadlines_ sont les suivantes:


|      Etape           | Date rendue            |
|----------------------|------------------------|
| Date du rendu        | XX décembre 2026 23h59 |
| Date des soutenances | XX janvier 2026        |
...
Le projet doit articuler **trois (ENSAE) ou quatre (ENSAI) dimensions complémentaires** :

1. La récupération de données issue de plusieurs sources ;
2. L'exploration de l'information présentes dans celles-ci ;
3. La visualisation et la communication des résultats ;
4. L'analyse (ENSAE, ENSAI) ou la modélisation (ENSAI).
...
Cette partie de l'évaluation disparaît des critères pour les élèves de l'ENSAE à partir de la rentrée 2026: un cours consacré à Python pour l'algorithmique et le ML est présent au S2. Les éléments suivants ne concernent donc que les élèves de l'ENSAI. 
...
* Écrire un rapport sous forme de _notebook_ (quelques exceptions à cette règle peuvent exister, par exemple si vous développer une appli `Streamlit` comme expliqué dans la @nte-appli) ou de site web `Quarto Markdown`. Soyez vigilant avec le contrôle de version (@imp-gitnb)
...
* Les dépendances utiles au projet doivent être faciles à installer, par exemple par le biais d'un `requirements.txt` ou `pyproject.toml`.
...
Pour les élèves de l'ENSAE:

| Catégorie                                         | Points |
|---------------------------------------------------|--------|
| Données (collecte et nettoyage)                   | 4      |
| Analyse descriptive                               | 4      |
| Démarche scientifique et reproductibilité du projet | 5      |
| Format du code (code propre, documenté...)            | 2      |
| Soutenance                                        | 5      |


Pour les élèves de l'ENSAI:
