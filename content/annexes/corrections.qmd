...
```{ojs}
renderCorrection({fpath: "content/manipulation/02b_pandas_intro.qmd", correction: true})
```

* [Manipulations de données avec `Pandas`](../manipulation/02_pandas_suite.qmd)

```{ojs}
renderCorrection({fpath: "content/manipulation/02b_pandas_TP.qmd", correction: true})
```
