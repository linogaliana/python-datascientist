...
description-en: |
  Corrected notebooks for the different chapters of the course
echo: false
...
Only the chapters whose corrections are not visible are listed on this page.
:::
...
::: {.content-visible when-profile="en"}
* [Back to `Numpy`](/content/manipulation/01_numpy.qmd)
:::
...
::: {.content-visible when-profile="en"}
* [Introduction to `Pandas`](../manipulation/02_pandas_intro.qmd)
:::
...
* [Associer des données avec `Pandas` : les jointures](../manipulation/02_pandas_joins.qmd)

{{< badges
    fpath="/content/manipulation/02_pandas_joins.qmd"
    printMessage="false"
    correction="true"
>}}

* [Manipuler des données avec `Pandas` : statistiques et restructuration](../manipulation/02_pandas_stats.qmd)

{{< badges
    fpath="/content/manipulation/02_pandas_stats.qmd"
    printMessage="false"
    correction="true"
>}}
...
::: {.content-visible when-profile="en"}
Go to the corresponding page on [https://pythonds.linogaliana.fr/en](https://pythonds.linogaliana.fr/en) to read the content.
:::
::::
