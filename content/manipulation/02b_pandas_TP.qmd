...
<div class="container">
  <div class="image" style = "width: 50%;">
    <img src="select_pandas.png" />
  </div>
  <div class="image" style = "width: 50%;">
    <img src="rename_pandas.png" />
  </div>
  <div class="image" style = "width: 50%;">
    <img src="mutate_pandas.png" />
  </div>
  <div class="image" style = "width: 50%;">
    <img src="filter_pandas.png" />
  </div>
  <div class="image" style = "width: 50%;">
    <img src="arrange_pandas.png" />
  </div>
</div>
...
4. Créer les variables suivantes:
    - `dep`: le département. Celui-ci peut être créé grâce aux deux premiers caractères de `code_insee` en appliquant la méthode `str`[^notecorse]
