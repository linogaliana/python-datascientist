...
#| output: asis
if lang == "en":
    print("Let's try to map these DPEs (energy performance certificates) with the construction years of the buildings. With `Folium`, we get the following interactive map:")
else:
    print("Essayons de représenter sur une carte ces DPE avec les années de construction des logements. Avec `Folium`, on obtient la carte interactive suivante :")
```
