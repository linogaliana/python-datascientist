...
__La partie utilisant l'API DVF n'est plus à jour, elle sera mise à jour prochainement.__
...
```{=html}
<div class="alert alert-success" role="alert">
<h3 class="alert-heading"><i class="fa-solid fa-pencil"></i> Exercice 3 : Retrouver des produits dans l'openfood facts :pizza:</h3>
```
