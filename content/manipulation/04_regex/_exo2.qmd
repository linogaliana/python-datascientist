...
content_html = '''
    ...
    <div class="callout callout-exercise">
        <div class="callout-header-exercise">
            <i class="fa-solid fa-pen-fancy"></i> Exercice 2: extraction d\'adresses email
        </div>
...
content_html = '''
    ...
    <div class="callout callout-exercise">
        <div class="callout-header-exercise">
            <i class="fa-solid fa-pen-fancy"></i> Exercise 2: Extracting email addresses
        </div>
        <div class="callout-body">
            <p>Use the structure of an email address <code>[XXXX]@[XXXX]</code> to retrieve this content.</p>
        </div>
    </div>
