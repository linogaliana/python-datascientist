...
categories:
  ...
  - Manipulation
description: |
  `Pandas` is the central element of the `Python` ecosystem for data science. This chapter presents the initial data manipulation tasks you can perform with `Pandas` to explore the structure of your dataset.
...
::: {.note}
If you are interested in `R` and the _tidyverse_, a very similar version of this exercise is available in [this course](https://rgeo.linogaliana.fr/exercises/r-wrangling.html).
:::
...
## Before the `DataFrame`, the `Series`
...
{{< include "01_numpy_exercises/_exo0_preliminary.qmd" >}}
{{< include "01_numpy_exercises/_exo0_en.qmd" >}}
{{< include "01_numpy_exercises/_exo0_solution.qmd" >}}
