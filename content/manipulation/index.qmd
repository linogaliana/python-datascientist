...
et des exercices guidés. Il est possible de les consulter sur ce site ou d'utiliser l'un des badges présents en début de chapitre, par exemple ceux-ci pour ouvrir le [chapitre d'exercices sur `Pandas`](/content/manipulation/02_pandas_intro.qmd):
...
and guided exercises. You can view them on this site or use one of the
badges at the beginning of the chapter, for example
these to open the [Pandas exercises chapter](/content/manipulation/02_pandas_intro.qmd):
