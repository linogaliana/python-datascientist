...
La base en question contient des livres de la British Library et quelques informations les concernant. Le jeu de données est disponible ici : https://raw.githubusercontent.com/realpython/python-data-cleaning/main/Datasets/BL-Flickr-Images-Book.csv
...
1. Lire les données depuis l'url `https://raw.githubusercontent.com/realpython/python-data-cleaning/main/Datasets/BL-Flickr-Images-Book.csv`. Attention au séparateur
...
# Question 1
data_books = pd.read_csv('https://raw.githubusercontent.com/realpython/python-data-cleaning/main/Datasets/BL-Flickr-Images-Book.csv',sep=',')
```
