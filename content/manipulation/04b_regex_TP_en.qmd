...
The dataset in question contains books from the British Library and some related information. The dataset is available here: https://raw.githubusercontent.com/realpython/python-data-cleaning/main/Datasets/BL-Flickr-Images-Book.csv
...
1. Read the data from the URL `https://raw.githubusercontent.com/realpython/python-data-cleaning/main/Datasets/BL-Flickr-Images-Book.csv`. Be careful with the separator.
