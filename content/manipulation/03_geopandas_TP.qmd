...
description: |
  ...
  à manipuler.
echo: false
image: featured_geopandas_tp.png
---
...
La carte obtenue à l'issue de la question 4:
...
Et enfin, la carte finale, après mise en forme:
...
arrondissement_19e = petite_couronne.loc[stations_info['NOM'].str.contains("19e")]
```
