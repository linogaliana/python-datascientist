...
```
1. `StringIO` lets us treat the character string as the content of a file.
:::
...
![Source: [Documentation Databricks](https://www.databricks.com/fr/glossary/star-schema)](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/databricks-star-schema-erd.png)
...
![Source: [Databricks Documentation](https://www.databricks.com/fr/glossary/star-schema)](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/databricks-star-schema-erd.png)
...
![Parquet vs CSV](https://minio.lab.sspcloud.fr/lgaliana/ensae/python/img/upsolver-parquet-vs-csv.png)
