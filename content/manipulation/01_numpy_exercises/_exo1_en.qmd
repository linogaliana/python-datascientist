...
content_html = '''
    ...
    <div class="callout callout-exercise">
        ...
        <div class="callout-body">
            <p>Generate:</p>
<ul>
<li>$X$ a random variable, 1000 repetitions of a $U(0,1)$ distribution</li>
<li>$Y$ a random variable, 1000 repetitions of a normal distribution with zero mean and variance equal to 2</li>
<li>Verify the variance of $Y$ with <code>np.var</code></li>
</ul>
        </div>
    </div>
