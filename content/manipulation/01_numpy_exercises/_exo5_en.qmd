...
content_html = '''
    ...
    <div class="callout callout-exercise">
        <div class="callout-header-exercise">
            <i class="fa-solid fa-pen-fancy"></i> Exercise 5
        </div>
        <div class="callout-body">
            <ol>
<li>Sum all the elements of an <code>array</code>, the elements by row, and the elements by column. Verify the consistency.</li>
<li>Write a function <code>statdesc</code> to return the following values: mean, median, standard deviation, minimum, and maximum. Apply it to <code>x</code> using the <em>axis</em> argument.</li>
</ol>
        </div>
    </div>
