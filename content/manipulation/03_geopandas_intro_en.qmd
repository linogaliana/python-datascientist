...
categories:
  ...
  - Data Manipulation
description: |
  Geocoded data have been more and more used these recent years in research, public policies or business decisions, whether they come from open data or geocoded digital traces. For spatial data, the `GeoPandas` package extends the functionalities of the `Pandas` ecosystem to enable handling complex geographical data in a simple manner.
...
1. **Geographical data** (or geometries): geometric objects such as points, vectors, polygons, or meshes (*raster*). Example: the shape of each municipality, the coordinates of a building;
2. **Attributive data** (or attributes): measurements and characteristics associated with geometric objects. Example: the population of each municipality, the number of windows and the number of floors of a building.
...
## Spatial data are essential

Initially used mainly for military or administrative purposes, cartographic production has been very common since at least the 19th century to represent socioeconomic information. The most well-known representation in this field is the choropleth map[^limite-choro].
...
## Where to find French spatial data?
...
{{< include "03_pandas_intro/_exo1_en.qmd" >}}
{{< include "03_pandas_intro/_exo1_solution.qmd" >}}
...
{{< include "03_pandas_intro/_exo2_en.qmd" >}}
{{< include "03_pandas_intro/_exo2_solution.qmd" >}}
...
{{< include "03_pandas_intro/_exo3_en.qmd" >}}
{{< include "03_pandas_intro/_exo3_solution.qmd" >}}
...
{{< include "03_pandas_intro/_exo4_en.qmd" >}}
{{< include "03_pandas_intro/_exo4_solution.qmd" >}}
...
{{< include "03_pandas_intro/_exo5_en.qmd" >}}
{{< include "03_pandas_intro/_exo5_solution.qmd" >}}
