...
```{r, fig.cap = "Cheasheet pandas, d'après <https://becominghuman.ai/cheat-sheets-for-ai-neural-networks-machine-learning-deep-learning-big-data-678c51b4b463>", out.width = "90%", echo = FALSE}
knitr::include_graphics("https://cdn-images-1.medium.com/max/2000/1*YhTbz8b8Svi22wNVvqzneg.jpeg")
```
...
```{r tidy data, out.width = "90%", echo = FALSE, fig.cap = "Concept de tidy data (emprunté à H. Wickham)"}
