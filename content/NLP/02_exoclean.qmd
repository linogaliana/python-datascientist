...
# Calculate TF-IDF scores for the term "chat" in each document
...
3. Trouver les 50 extraits où le score TF-IDF du mot _"fear"_ est le plus élevé et l'auteur associé. Vous devriez obtenir le classement suivant :
