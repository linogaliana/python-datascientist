...
méthodes fréquentistes dans le paradigme _bag of words_. Celles-ci sont certes un peu _old school_ par rapport aux approches plus raffinées que nous évoquerons ultérieurement mais les présenter nous permettra d'évoquer un certain nombre d'enjeux typique des données textuelles qui reste central dans le NLP moderne.
...
Le fait d'avoir un corpus confrontant plusieurs auteurs nous permettra de faire des analyses comparatives là où la base précédente nous permettra surtout de présenter les enjeux principaux. 
