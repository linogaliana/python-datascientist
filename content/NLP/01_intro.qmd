...
```{python}
#| echo: false
#| label: fig-waffle-fear-en
#| fig-cap: "Distribution of the term fear in the corpus of our three authors"
#| output: true
...
::: {.content-visible when-profile="en"}
```{python}
#| label: fig-waffle-horror-en
#| fig-cap: "Distribution of the term horror in the corpus of our three authors"
fig.get_figure()
```
