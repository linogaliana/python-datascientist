...
def reminder_badges(
    ...
    notebook = re.sub(r"(.Rmd|.qmd)", ".ipynb", source_file)
    if correction:
    ...
    github_repo_notebooks_simplified = (
        "github/linogaliana/python-datascientist-notebooks"
    )
    github_alias = github_repo_notebooks_simplified.replace("github", "github.com")
    github_repo_notebooks = f"https://{github_alias}"
    ...
    if notebook == "":
        ...
        github_link = github_repo_notebooks + "/blob/main"
        nbviewer_link = (
            "https://nbviewer.jupyter.org/"
            + github_repo_notebooks_simplified
    ...
    if type == "md":
        ...
        download_link = (
            '<a href="https://downgit.github.io/#/home?url='
    ...
    github_link = (
        f'<a href="{github_link}{notebook_rel_path}" class="github">'
    ...
    if type == "md":
        ...
        nbviewer_link = (
            f'<a href="{nbviewer_link}" target="_blank" rel="noopener">'
    ...
    sspcloud_jupyter_link_launcher = (
        f"https://datalab.sspcloud.fr/launcher/ide/jupyter-{ssp_cloud_service}{gpu_suffix}"
    ...
    if type == "md":
        ...
        sspcloud_jupyter_link = (
            f'<a href="{sspcloud_jupyter_link_launcher}" target="_blank" rel="noopener">'
    ...
    sspcloud_vscode_link_launcher = (
        f"https://datalab.sspcloud.fr/launcher/ide/vscode-{ssp_cloud_service}{gpu_suffix}"
        f"?autoLaunch=true&onyxia.friendlyName=%C2%AB{chapter_no_extension}%C2%BB"
    ...
    if type == "md":
        ...
        sspcloud_vscode_link = (
            f'<a href="{sspcloud_vscode_link_launcher}" target="_blank" rel="noopener">'
    ...
    if type == "md":
        ...
        colab_link = (
            f'<a href="https://colab.research.google.com/github/linogaliana/python-datascientist-notebooks/blob/main{notebook_rel_path}" target="_blank" rel="noopener">'
    ...
    if type == "md":
        ...
        vscode_link = (
            f'<a href="https://github.dev/linogaliana/python-datascientist-notebooks{notebook_rel_path}" target="_blank" rel="noopener">'
