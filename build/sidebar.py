...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process YAML headers in Quarto .qmd files.")
    parser.add_argument('--to', choices=['english', 'french'], required=True, help="Specify the target language (english or french).")
    parser.add_argument('--root-dir', type=str, default=os.getcwd(), help="Root directory to start processing (default: current directory).")
