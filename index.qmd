...
```{python}
from build.homepage.syllabus import build_syllabus_df, add_titles_from_qmd
...
df_prepared = df_prepared.select(
    ["title_link", "section", "classroom_icon", "classroom", "material_icon"]
)
```
...
section = df_prepared.filter(pl.col("section") == "Introduction")
...
(
    ...
    .pipe(gte.gt_merge_stack,
        col1="classroom_icon",
        col2="classroom"
    )
    .pipe(gte.gt_theme_dark)
)
```
